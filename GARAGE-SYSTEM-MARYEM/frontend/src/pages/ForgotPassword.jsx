      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="form-group">
            ...
            <input type="email" id="email" className="form-input" placeholder={t('auth.email_placeholder')} value={email} onChange={(e) => setEmail(e.target.value)} required />
          </div>
          ...
          <Link to="/signup" className="auth-link-button small"> {t('auth.create_new_account')} </Link>
        </form>
